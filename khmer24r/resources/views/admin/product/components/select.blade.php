...
<!-- មុខងារ isset() ពិនិត្យមើលថាតើអថេរត្រូវបានកំណត់ឬអត់ ដែលមានន័យថាវាត្រូវតែត្រូវបានប្រកាស ហើយមិនមែនជា NULL ទេ។ -->

<!-- The in_array() function searches an array for a specific value. -->
<!-- មុខងារ in_array() ស្វែងរក array សម្រាប់តម្លៃជាក់លាក់មួយ។ -->

<!-- The is_object() function checks whether a variable is an object. -->
<!-- អនុគមន៍ is_object() ពិនិត្យមើលថាតើអថេរគឺជាវត្ថុមួយ។ -->

<!-- The is_array() function checks whether a variable is an array or not. -->
<!-- មុខងារ is_array() ពិនិត្យមើលថាតើអថេរមួយជាអារេឬអត់។ -->
