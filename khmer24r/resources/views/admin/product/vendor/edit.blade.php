                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" class="update_form" action="{{ route('vendor.update',$vendor->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" name="email" value="{{ $vendor->email }}" class="form-control" id="input-21" placeholder="Email" />
                                        <span class="text-danger name"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="input-21" class="col-sm-2 col-form-label">Mobile no</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="mobile_no" value="{{ $vendor->mobile_no }}" class="form-control" id="input-21" placeholder="mobile_no" />
                                        <span class="text-danger name"></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="address" class="form-control" cols="30" rows="5">{!! $vendor->address !!}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <img src="{{asset('uploads/vendor/'.$vendor->image)}}" style="height: 40px;" alt="">
