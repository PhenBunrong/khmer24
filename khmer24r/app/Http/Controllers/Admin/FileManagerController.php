...
class FileManagerController extends Controller {
    ...
    public function store_file(Request $request)
    {
        if ($request->hasFile('fm_file')) {
            ...
            //អនុគមន៍ uniqid() បង្កើតលេខសម្គាល់តែមួយគត់ដោយផ្អែកលើ microtime (ពេលវេលាបច្ចុប្បន្នគិតជាមីក្រូវិនាទី)។
            ...
            $image->fit(848, 438, function ($constraint) {
                $constraint->aspectRatio(); // aspectRatio = សមាមាត្រ
            });
            ...
            // 3 square
            $canvas = interImage::canvas(400, 400); //canvas = ផ្ទាំងក្រណាត់
