...
class UserController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        //អនុគមន៍ hash() ត្រឡប់តម្លៃ hash សម្រាប់ទិន្នន័យដែលបានផ្តល់ឱ្យដោយផ្អែកលើ algorithm ដូចជា (md5, sha256)។ តម្លៃត្រឡប់គឺជាខ្សែអក្សរដែលមានលេខគោលដប់ប្រាំមួយ (តម្លៃគោលដប់ប្រាំមួយ)។
